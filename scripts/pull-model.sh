...
echo "  docker compose -f \"$COMPOSE_FILE\" --project-directory \"$REPO_ROOT\" exec ollama ollama run \"${SELECTED_MODEL}\""
echo ""
echo "To list all downloaded models:"
echo "  docker compose -f \"$COMPOSE_FILE\" --project-directory \"$REPO_ROOT\" exec ollama ollama list"
